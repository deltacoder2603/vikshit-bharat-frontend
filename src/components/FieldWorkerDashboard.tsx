...
export default function FieldWorkerDashboard({ 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-green-50">
      <ResponsiveNavbar
        user={user}
        notifications={[{ id: 1 }]} // Mock notification
        language={language}
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="flex-1 mb-4 md:mb-0">
                ...
                <motion.p 
                  ...
                  className="opacity-90 text-sm sm:text-base lg:text-lg"
                >
                  {language === 'hindi' 
        ...
        >
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 hover:shadow-lg transition-shadow">
            <CardContent className="p-4 sm:p-8 text-center">
              ...
              >
                <Star className="h-8 w-8 sm:h-12 sm:w-12" />
              </motion.div>
                  ...
                  <CardContent className="p-8">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold mb-3">{report.description}</h3>
            ...
            >
              ...
              <p className="text-gray-500 text-lg">
                {activeTab === 'assigned' 
                  ...
                  : activeTab === 'pending' 
                  ? (language === 'hindi' ? 'कोई नया कार्य प्रतीक्षा में नहीं है' : 'No new tasks are waiting')
                  : (language === 'hindi' ? 'अभी तक कोई कार्य पूर्ण नहीं किया गया' : 'No tasks have been completed yet')}
              </p>
            </motion.div>
          )}
        </motion.div>
