...
export default function Dashboard({ user, onSubmitReport, onViewHistory, onViewProfile, onLogout, language, onLanguageChange }: DashboardProps) {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = async (event) => {
        ...
        console.log('🎯 Image data URL created, length:', result?.length);
        ...
        if (result) {
          ...
          try {
            ...
            console.log('📋 Categories found:', analysisResult.categories);
  ...
  // Handle clicking anywhere in the upload area
            ...
            <CardContent className="p-4 sm:p-6 lg:p-8">
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 lg:space-y-8">
                ...
                />
                  ...
                  <div className={`
                    border-2 border-dashed rounded-lg sm:rounded-xl p-6 sm:p-8 lg:p-12 text-center 
                  ...
                  >
                    {imagePreview ? (
                      ...
                      >
                        {/* Success Badge */}
                        <div className="absolute -top-3 -right-3 bg-green-500 text-white rounded-full w-8 h-8 flex items-center justify-center z-10 shadow-lg">
                          <CheckCircle className="w-4 h-4" />
                        </div>
                        
                        {/* Image Preview Container */}
                        <div className="relative overflow-hidden rounded-xl border-4 border-white shadow-2xl bg-white">
                          <img
                            src={imagePreview}
                            alt="Selected Image Preview"
                            className="w-full max-h-80 object-contain mx-auto"
                            onLoad={() => console.log('✅ Image preview displayed successfully')}
                            onError={(e) => {
                              console.error('❌ Image preview failed to display:', e);
                              toast.error(language === 'hindi' ? 'तस्वीर दिखाने में स���स्या' : 'Error displaying image');
                            }}
                          />
                        </div>
                        ...
                        {imageFile && (
                          <motion.div 
                            initial={{ y: 20, opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                            className="mt-4 text-sm text-gray-600 bg-white rounded-lg p-3 shadow-sm border border-green-200"
                          >
                            <div className="flex items-center justify-center space-x-3">
                              <CheckCircle className="w-4 h-4 text-green-500" />
                              <div>
                                <p className="font-medium truncate max-w-48">{imageFile.name}</p>
                        ...
                        <div className="flex justify-center gap-3 mt-6">
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="shadow-lg bg-white hover:bg-red-50 border-red-200 text-red-600"
                            onClick={(e) => {
                              e.stopPropagation();
                              handleRemoveImage();
                            }}
                          ...
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="shadow-lg bg-white hover:bg-blue-50 border-blue-200 text-blue-600"
                            onClick={(e) => {
                              e.stopPropagation();
                              const fileInput = document.getElementById('image-upload') as HTMLInputElement;
                              fileInput?.click();
                      ...
                      <div className="space-y-6">
                        <motion.div 
                          className="mx-auto w-24 h-24 bg-gradient-to-br from-blue-400 to-green-500 rounded-full flex items-center justify-center shadow-xl"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className={`border-blue-200 px-3 whitespace-nowrap ${
                        !isLocationAvailable 
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="border-blue-200 focus:border-blue-500 min-h-40"
                    required
                  />
                </div>
                ...
                >
                  <Button
                    ...
                    className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white px-12 py-4 text-lg shadow-xl"
                  >
                    {isSubmitting ? (
