...
export default function EnhancedProfilePage({ 
  ...
  const sections: ProfileSection[] = [
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="dateOfBirth">
                    {language === 'hindi' ? 'जन्म त��थि' : 'Date of Birth'}
                  </Label>
                  {isEditing ? (
                    <Input
                      id="dateOfBirth"
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="flex justify-between">
                    <span>{language === 'hindi' ? 'प्रमाणीकरण प्रकार:' : 'Auth Type:'}</span>
                    <Badge className="bg-green-100 text-green-800">
                      {user.authType === 'aadhaar' ? 
                        (language === 'hindi' ? 'आधार' : 'Aadhaar') : 
                        'PAN'
                      }
                    </Badge>
                  </div>
                  <div className="flex justify-between">
                    <span>{language === 'hindi' ? 'प्रमाणीकरण संख्या:' : 'Auth Number:'}</span>
        ...
        <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-purple-100">
                      {language === 'hindi' ? 'योगदान स्कोर' : 'Contribution Score'}
                    </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>
                  {language === 'hindi' ? 'सेवा की गुणवत्ता' : 'Service Quality'}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between">
                  <span>{language === 'hindi' ? 'औसत समाधान समय' : 'Avg Resolution Time'}</span>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  {language === 'hindi' ? 'खाता जानकारी' : 'Account Information'}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex justify-between">
    ...
    {
      id: 'settings',
      title: language === 'hindi' ? 'सेटिंग्स और प्राथमिकताएं' : 'Settings & Preferences',
      icon: Settings,
      component: (
        <div className="space-y-6">
          {/* Language Preference */}
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>{language === 'hindi' ? 'भाषा प्राथमिकता' : 'Language Preference'}</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <select
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>{language === 'hindi' ? 'सुरक्षा' : 'Security'}</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <Button
              ...
              >
                ...
                {language === 'hindi' ? 'डेटा डाउनलोड करें' : 'Download Data'}
              </Button>
            </CardContent>
          </Card>
        </div>
                  ...
                  >
                    {isSaving ? (
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span>{language === 'hindi' ? 'सेव करें' : 'Save Changes'}</span>
                      </div>
                    )}
                  </Button>
                </motion.div>
