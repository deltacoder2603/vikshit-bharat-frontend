...
import { ArrowLeft, Clock, Bell, Settings, LogOut, Building, Briefcase, Shield, Menu, X, Crown, User, ChevronDown } from 'lucide-react';
...
export default function ResponsiveNavbar({
  ...
  return (
    <motion.header
      ...
      className="bg-white/95 backdrop-blur-md border-b border-orange-200/50 shadow-xl sticky top-0 z-50"
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            {/* Notifications */}
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="ghost" size="sm" className="relative p-3 rounded-xl hover:bg-gray-100">
